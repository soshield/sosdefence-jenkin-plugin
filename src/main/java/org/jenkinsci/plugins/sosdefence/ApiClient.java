...
import org.jenkinsci.plugins.sosdefence.Messages;
...
public class ApiClient {
    ...
    public VersionNumber getVersion() throws ApiClientException {
        try {
            ...
            throw new ApiClientException(Messages.ApiClient_Error_Connection(Integer.parseInt(StringUtils.EMPTY), StringUtils.EMPTY), e);
